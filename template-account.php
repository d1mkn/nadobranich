...
<div class="container">
    ...
    <div class="cabinet-content">
        ...
        <?php else: ?>
            <div class="cabinet__auth">
                <button type="button" class="personal-data__btn" data-type="login">Вхід</button>
                <button type="button" class="personal-data__btn" data-type="register">Реєстрація</button>
            </div>
        <?php endif ?>
    </div>
</div>
